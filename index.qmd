...
With the goal to make data entry for applicants and hiring committees as easy and frictionless as possible, we developed the [RESQUE Collector App](https://resque-framework.github.io/website/web/) that allows to provide information for your best research outputs and to export the data in a JSON format.

We plan to provide three rating schemes for ...

- Publications, preprints, book chapters, etc.: (**RESQUE-Pubs**) - ✅ v0.4.0, ready for use (but still likely to change). See indicators [here](tech_doc/pub_indicators.qmd).
...
- Quality indicators for [Theory Usage and Development](tech_doc/theory_indicators.qmd)
