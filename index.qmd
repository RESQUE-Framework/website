  ...
  <div class="grid" style="--bs-gap: 0.5rem;">
    ...
    <div class="g-col-6 g-col-md-4">
      <div class="content-box">
        ...
        <p><strong>👉🏼 "Buffet table" approach:</strong> Escape h-index and JIF by choosing valid indicators that suit your research assessment scenario.</p>
      </div>
    </div>
...
- [**RESQUE-Pubs**](tech_doc/pub_indicators.qmd) (Publications, preprints, book chapters, etc.): ✅ ready for use (but still likely to change in detail).
...
The core sets are supposed to be a good fit to most areas of psychology.
...
**Available Expansion Packs (EPs):**

- [EP Clinical Psychology](tech_doc/EP-clinical_psychology.qmd)
- [Theory-guided research and theory development](tech_doc/EP-theorizing.qmd)
- [Epistemic Goals](tech_doc/EP-epistemic_goals.qmd)
- [Multi-/Interdisciplinarity](tech_doc/EP-multidisciplinary.qmd)
- [Practical Relevance](tech_doc/EP-practical_relevance.qmd)
- [Stimuli](tech_doc/EP-stimuli.qmd)


### 📊 The RESQUE Research Profile

The [RESQUER](https://resque-framework.github.io/RESQUER/index.html) package for R ...

1. loads and aggregates multiple json files with RESQUE ratings
2. enriches the data with other open sources of information (e.g. citation counts & normalized citation counts from [OpenAlex](https://openalex.org), impact metrics from [BIP!](https://bip.imsi.athenarc.gr))
3. provides candidate profiles that can be requested by hiring and tenure committees, or used by candidates as an attachment to their CV or website.
