...
See our separate document ["How to create a custom copy of the Collector App"](https://github.com/RESQUE-Framework/collector-app-eichstaett/blob/main/How_to_fork.md), which explains step by step where and how changes can be done.
:::
