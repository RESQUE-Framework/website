...
The app is completely [open source](https://github.com/RESQUE-Framework), so all indicators can be adjusted, removed, or new indicators added. However, we are happy to [assist](team.qmd) in customizing the app for your hiring committee.
