...
doi_csv <- paste0(dois_normalized, collapse=",") |> URLencode(reserved=TRUE)
...
pop_sel <- BIP %>% filter(pop_class <= "C4") %>% arrange(pop_class)
...
# TODO: Compute rough norm values (e.g., 5 categories)
```
