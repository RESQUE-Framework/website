...
![](img/paper_profile_1.png){width="500"}

1. If it is a preprint and has no doi yet, check "DOI unavailable?" and enter the metadata (title, year, URL) manually.
...
![](img/paper_profile_2.png){width="500"}
