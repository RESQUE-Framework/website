  ...
  <div class="grid" style="--bs-gap: 0.5rem;">
    ...
    <div class="g-col-6 g-col-md-4">
      <div class="content-box">
        ...
        <p><strong>👉🏼 Menu approach:</strong> Escape h-index and JIF by choosing valid indicators that suit your research assessment scenario.</p>
      </div>
    </div>
    ...
    <div class="g-col-6 g-col-md-4">
      <div class="content-box">
        ...
        <ul>
          <li><a href="https://resque-framework.github.io/collector-app/">Data entry app</a> for applicants</li>
