...
With the goal to make data entry for applicants and hiring committees as easy and frictionless as possible, we developed a [web form](https://nicebread.github.io/RESQUE/web/) that allows to enter and store the data in a JSON format.
...
The web form currently only implements *RESQUE-Pubs* and *RESQUE-Software*.
